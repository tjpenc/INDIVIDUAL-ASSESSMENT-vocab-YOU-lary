...
vocab-YOU-lary
This project is a CRUD app that allows users to create, view, update, and delete their own set of vocabulary cards. Cards are viewed by user, so different users can login and personalize their own cards
